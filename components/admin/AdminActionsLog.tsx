...
export function AdminActionsLog() {
  ...
  const loadActions = async (isRefresh = false) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/admin-actions-log?${params}`, {
        method: 'GET',
        headers: {
  ...
  const deleteAction = async (id: number) => {
    ...
    setDeletingId(id)
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/admin-actions-log?id=${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${(await supabase.auth.getSession()).data.session?.access_token}`,
          'Content-Type': 'application/json'
  ...
  const processBulkPromo = async () => {
    ...
    try {
      ...
      // Log bulk action
      await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/admin-actions-log`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${(await supabase.auth.getSession()).data.session?.access_token}`,
          'Content-Type': 'application/json'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setFilters((prev: any) => ({ ...prev, admin_email: e.target.value }))}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFilters((prev: any) => ({ ...prev, user_email: e.target.value }))}
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setFilters((prev: any) => ({ ...prev, action_type: e.target.value }))}
                className="w-full px-3 py-2 border border-theme-light rounded-lg bg-theme-surface text-theme-primary focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFilters((prev: any) => ({ ...prev, start_date: e.target.value }))}
                className="w-full px-3 py-2 border border-theme-light rounded-lg bg-theme-surface text-theme-primary focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFilters((prev: any) => ({ ...prev, end_date: e.target.value }))}
                className="w-full px-3 py-2 border border-theme-light rounded-lg bg-theme-surface text-theme-primary focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </div>
            ...
            <div className="px-6 py-4 space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setBulkPromoData((prev: any) => ({ ...prev, emails: e.target.value }))}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setBulkPromoData((prev: any) => ({ ...prev, duration_days: parseInt(e.target.value) }))}
                  className="w-full px-3 py-2 border border-theme-light rounded-lg bg-theme-surface text-theme-primary focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBulkPromoData((prev: any) => ({ ...prev, notes: e.target.value }))}
