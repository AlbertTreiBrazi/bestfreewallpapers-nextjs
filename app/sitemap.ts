...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const [wallpapersRes, ringtonesRes, liveRes, categoriesRes] = await Promise.all([
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/collections`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.6 },
  ...
  return [...staticUrls, ...wallpaperUrls, ...ringtoneUrls, ...liveUrls, ...categoryUrls]
}
